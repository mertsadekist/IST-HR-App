...
// Build a branded, print-ready HTML string for a generated letter (used for PDF).
function buildLetterHtml(letter) {
  ...
  return `
    ...
    <div dir="${rtl ? 'rtl' : 'ltr'}" style="white-space:pre-wrap;font-size:14px;line-height:1.9;color:#111;text-align:${rtl ? 'right' : 'left'};">${escapeHtml(content)}</div>
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <SendDocumentModal
        ...
        getHtml={() => buildLetterHtml(sendLetter)}
